...
ColBuilder generates `posre_*.itp` files with a default force constant of **1.0 kcal·mol^-1·Å^-2**. In this workflow, we used different position-restraint force constants at specific stages, so the `posre_*.itp` files were updated accordingly:

- **A.NVT, 0.5 fs timestep:** 2.5 kcal·mol^-1·Å^-2
  - Use `update_posre_2500.py` in `Equilibration/A.NVT/2500/` to update the force constant.
- **B.NPT, 1 fs and 2 fs timesteps:** 0.3 kcal·mol^-1·Å^-2
...
**A) 0.5 fs timestep, position restraint force constant 2.5 kcal·mol^-1·Å^-2**
...
**B) 1.0 fs timestep, position restraint force constant 1.0 kcal·mol^-1·Å^-2**
...
**C) 2.0 fs timestep, position restraint force constant 1.0 kcal·mol^-1·Å^-2**
...
**A) 0.5 fs timestep, position restraint force constant 1.0 kcal·mol^-1·Å^-2**
...
**B) 1.0 fs timestep, position restraint force constant 0.3 kcal·mol^-1·Å^-2**
...
**C) 2.0 fs timestep, position restraint force constant 0.3 kcal·mol^-1·Å^-2**
